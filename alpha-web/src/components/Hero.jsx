...
export default function Hero() {
    ...
    return (
        <section>
            ...
            <Article title=""
                    text={"Venta de productos/nNos dedicamos a la venta de equipos médicos para uso veterinario, especialmente endoscopios tanto veterinarios como industriales. Ofrecemos asesoramiento en la compra de equipos de endoscopia para uso en medicina humana."}
